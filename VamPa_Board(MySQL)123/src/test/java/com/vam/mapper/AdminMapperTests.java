...
public class AdminMapperTests {
	 ...
	 * 
	 * BookVO book = new BookVO(); book.setBookName("메퍼 테스트");
	 * book.setAuthorId(123); book.setPubleYear("2021-03-18");
	 * book.setPublisher("출판사"); book.setCateCode("0231"); book.setBookPrice(20000);
	 * book.setBookStock(300); book.setBookDiscount(0.23);
	 * book.setBookIntro("책 소개"); book.setBookContents("책 목차");
	 * 
